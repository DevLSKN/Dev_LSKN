    ...
    if (response.ok) {
      ...
      if (pendingService) {
        ...
        try {
          ...
          console.error('Error:', error);
          alert('Error al contratar el servicio: ' + error.message);
        }
      } else {
...
const handleContratarServicio = async (serviceName) => {
  ...
  return React.createElement(
    'div',
    {
      className: 'fixed right-12 top-1/2 transform -translate-y-1/2 flex flex-col gap-6'
    },
        ...
        React.createElement(
          'div',
          {
            className: `
              ...
              ${hoveredIndex === index ? 'w-60' : 'w-20'}  // Aumenta el tamaño del desplegable
              h-14 bg-white rounded-full cursor-pointer   // Aumenta el tamaño del botón
          ...
          [
            ...
            React.createElement('div', {
              key: 'indicator',
              className: 'min-w-[3rem] h-14 rounded-full bg-blue-500'  // Aumenta el tamaño del círculo
            }),
            ...
            React.createElement(
              'span',
              {
                key: 'title',
                className: `
                  text-black font-medium text-lg whitespace-nowrap overflow-hidden  // Aumenta el tamaño de la letra
                  transition-opacity duration-300
                  ${hoveredIndex === index ? 'opacity-100' : 'opacity-0'}
                  ml-3  // Mueve el texto hacia la izquierda
                `
              },
              section.title
            )
  ...
  <p className="text-center text-gray-300">No hay servicios contratados</p>
          ...
          <>
            ...
            {!showRegister && React.createElement(NavigationDots, {
